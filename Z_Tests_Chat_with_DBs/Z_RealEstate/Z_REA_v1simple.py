...
class RealEstateAssistant:
    ...
    def set_follow_up_limit(self, limit):
    ...
    def ask_question(self, question, user_id):
        ...
        # return answer
      # After follow_up_limit follow-up questions, feed memories to the Llama Index
        if self.follow_up_count >= self.follow_up_limit:
            return self.query_properties(user_id)
